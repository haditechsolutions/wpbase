...
<div class="white_card">
	<div class="card_header">
		...
		<p><?php esc_html_e( 'Become a Vendor', 'dokan-lite' ); ?></strong></p>
		</div>
	</div>
	<p>
        <?php esc_html_e( 'Vendors can sell products and manage a store with a vendor dashboard.', 'dokan-lite' ); ?>
	</p>
	<a href="<?php echo esc_url( dokan_get_page_url( 'myaccount', 'woocommerce', 'account-migration' ) ); ?>" class="btn solid small">
        <?php esc_html_e( 'Become a Vendor', 'dokan-lite' ); ?>
	</a>
</div>