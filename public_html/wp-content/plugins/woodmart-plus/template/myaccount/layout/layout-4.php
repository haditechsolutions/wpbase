         ...
         <form class="gap-y-2 aramis_register_form" method="POST" action="/">
            ...
            <div class="solid_input">
               <label class="gap-x">
                  ...
                  <?php esc_html_e( 'Username', 'woodmartplus' ); ?> <span class="text_danger">*</span>
               </label>
               <div class="input_container">
                  <input type="text"  name="username" placeholder="<?php esc_html_e( 'Your username', 'woodmartplus' ); ?>" />
...
<path d="M20 17.5C20 19.9853 20 22 12 22C4 22 4 19.9853 4 17.5C4 15.0147 7.58172 13 12 13C16.4183 13 20 15.0147 20 17.5Z" stroke="#1C274C" stroke-width="1.5"></path>
            ...
            <div class="solid_input">
               <label class="gap-x">
                  ...
                  <?php esc_html_e( 'Email address', 'woodmartplus' ); ?> <span class="text_danger">*</span>
               </label>
               <div class="input_container">
                  <input type="email"   name="email" placeholder="<?php esc_html_e( 'Your email address', 'woodmartplus' ); ?>" />
                  <span class="btn_clear" disabled>
                  <svg fill="#5e5e5b" width="18px" height="18px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<circle cx="12" cy="6" r="4" stroke="#1C274C" stroke-width="1.5"></circle>
<path d="M20 17.5C20 19.9853 20 22 12 22C4 22 4 19.9853 4 17.5C4 15.0147 7.58172 13 12 13C16.4183 13 20 15.0147 20 17.5Z" stroke="#1C274C" stroke-width="1.5"></path>
            ...
            <div class="solid_input">
               <label class="gap-x">
                  ...
                  <?php esc_html_e( 'Password', 'woodmartplus' ); ?><span class="text_danger">*</span>
               </label>
               <div class="input_container">
                  <input type="password" name="password" placeholder="<?php esc_html_e( 'Your Password', 'woodmartplus' ); ?>"/>
  ...
  <rect id="_Transparent_Rectangle_" data-name="&lt;Transparent Rectangle&gt;" class="cls-1" width="32" height="32"/>
            ...
            <button type="submit" class="btn solid medium font_semibold aramis__register_btn">
            ثبت نام
            </button>
         </form>
      ...
      <div class="white_card">
         ...
         <div class="parrent_aramis_login">
            ...
            <form class="gap-y-2 aramis_login" method="post">
               <div class="solid_input">
                  <label for="txtUsername" class="gap-x">
                     <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                        <path d="M7.5 2.25L6 15.75" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M12 2.25L10.5 15.75" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M2.625 6.75H16.125" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M1.875 11.25H15.375" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                     </svg>
                     نام کاربری <span class="text_danger">*</span>
                  </label>
                  <div class="input_container">
                     <input type="text" id="txtUsername" placeholder="نام کاربری شما" name="username"/>
                     <span class="btn_clear" disabled>
                     <svg fill="#5e5e5b" width="18px" height="18px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<circle cx="12" cy="6" r="4" stroke="#1C274C" stroke-width="1.5"></circle>
<path d="M20 17.5C20 19.9853 20 22 12 22C4 22 4 19.9853 4 17.5C4 15.0147 7.58172 13 12 13C16.4183 13 20 15.0147 20 17.5Z" stroke="#1C274C" stroke-width="1.5"></path>
               ...
               <div class="solid_input">
                  <label for="txtPassword" class="gap-x">
                     ...
                     گذرواژه <span class="text_danger">*</span>
                  </label>
                  <div class="input_container">
                     <input type="password" id="txtPassword" placeholder="نام کاربری شما" name="password" />
                     <span class="btn_clear" disabled>
                     <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" width="18px" height="18px" viewBox="0 0 32 32" id="icon">
  <defs>
    <style>
  ...
  <rect id="_Transparent_Rectangle_" data-name="&lt;Transparent Rectangle&gt;" class="cls-1" width="32" height="32"/>
               ...
               <?php 
                  ...
                  ?>
               <button type="submit" class="btn solid medium font_semibold aramis__login_btn">
