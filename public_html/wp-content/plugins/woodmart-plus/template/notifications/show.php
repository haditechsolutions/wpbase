<div class="white_card">
   <div class="card_header">
      <div class="title">
         ...
         <p><?php echo esc_html_e('Notification','woodmartplus'); ?></p>
      </div>
      <hr>
   </div>
   <!-- open the notification item -->
   <div class="outline_card--border_row">
         ...
         <div class="gap-x">
            <a href="<?php echo esc_url( wc_get_endpoint_url( 'notifications' ) ) ; ?>" class="btn link_primary">
               <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                  <path d="M5.25005 2.38L9.05338 6.18333C9.50255 6.6325 9.50255 7.36749 9.05338 7.81666L5.25005 11.62" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
               </svg>
      ...
      <div class="item gap-y-2">
         <div class="space_between">
            <p><?php echo esc_html( $notifications['title_notif'] ); ?></p>
            <div class="badge_gray--oneline">
               ...
               <p class="text_sm"><?php echo esc_html( wplus_helper::date_to_garegorian($notifications['date_create_notification']) ) ?></p>
            </div>
         </div>
         <div class="article_item--3">
            <div class="article_cover">
                <?php
                $img_src = ''; 
                if( isset( $notifications['image'] ) && !empty($notifications['image'] ))
                {
                    $img_src = wp_get_attachment_image_src($notifications['image'],'large'); 
                }
                
                ?>
               <img src="<?php echo isset( $img_src[0] ) && !empty( $img_src[0] ) ? esc_url( $img_src[0] ) : WOODPLUS_ASSET . 'img/post-cover.png' ?>" alt="notification cover image">
            </div>
            <p class="article_text">
               <?php echo esc_html( $notifications['description'] ); ?>
            </p>
         </div>
      </div>
   </div>
