...
?>
<div class="layout-3 product_card small_button tag_image align_center product_carousel_layout_3">
        ...
        <div class="product_middle">
            ...
            <div class="product_menu">
                <div class="product_menu__items">
                    ...
                    <?php  wplus_helper::load_custom_add_to_cart_template($product,'loop.carousel-layout-3'); ?>
