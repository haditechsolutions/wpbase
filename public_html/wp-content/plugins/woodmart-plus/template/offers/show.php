<div class="white_card">
   <div class="card_header">
      <div class="title">
         ...
         <p><?php esc_html_e('Offer','woodmartplus'); ?></p>
      </div>
      <hr>
   </div>
   ...
   <div class="outline_card--border_row">
      ...
      <div class="item gap-y-2">
         <div class="space_between">
            <p><?php echo esc_html( $offers['title_coupon'] ); ?></p>
            <div class="badge_gray--oneline">
               ...
               <p class="text_sm"><?php echo $offers['coupon_code']; ?></p>
            </div>
         </div>
         <div class="article_item--3">
            <div class="article_cover">
                <?php
                $img_src = '';
                if( isset( $offers['image'])  && !empty( $offers['image'] ) ){

                    $img_src = wp_get_attachment_image_src($offers['image'],'medium');    
            ...
            <p class="article_text">
               <?php echo esc_html( $offers['description'] ); ?>
            </p>
         </div>
      </div>
   </div>
