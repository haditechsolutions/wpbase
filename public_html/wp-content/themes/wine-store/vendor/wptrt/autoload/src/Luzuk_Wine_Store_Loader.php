...
class Luzuk_Wine_Store_Loader {
	 ...
	 * @return void
	 */
	public function luzuk_wine_store_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function luzuk_wine_store_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function luzuk_wine_store_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function luzuk_wine_store_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->luzuk_wine_store_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function luzuk_wine_store_load( $class ) {
