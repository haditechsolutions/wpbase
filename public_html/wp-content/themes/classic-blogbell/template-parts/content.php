...
?>
<?php 
	$enable_category     = classic_blogbell_get_option( 'latest_category_enable' );
	$enable_author     = classic_blogbell_get_option( 'latest_author_enable' );
	$enable_comment     = classic_blogbell_get_option( 'latest_comment_enable' );
	$enable_read_more_text     = classic_blogbell_get_option( 'latest_read_more_text_enable' );
    $enable_posted_on     = classic_blogbell_get_option( 'latest_posted_on_enable' );
    $enable_content     = classic_blogbell_get_option( 'latest_content_enable' );
    $enable_video = classic_blogbell_get_option( 'latest_video_enable' );
    $header_font_size = classic_blogbell_get_option( 'latest_font_size');
	$latest_readmore_text = classic_blogbell_get_option( 'latest_readmore_text' );
	$blog_layout_content_type = classic_blogbell_get_option( 'blog_layout_content_type' );
	$content_align = classic_blogbell_get_option( 'archive_content_align' );
	$background_image_enable = classic_blogbell_get_option( 'background_image_enable' );
...
<?php } else { ?>
	<article id="post-<?php the_ID(); ?>" <?php if ($blog_layout_content_type=='blog-one' || $blog_layout_content_type=='blog-seven'){ post_class( 'grid-item' ); } else{post_class('post-loadmore');} ?> >
		<div class="post-item">
			<?php 
			    ...
			    <?php } else { ?>
			    		<?php if ($blog_layout_content_type=='blog-two'||$blog_layout_content_type=='blog-three'|| $blog_layout_content_type=='blog-five' || $blog_layout_content_type=='blog-six'|| $blog_layout_content_type=='blog-seven'){ ?>
			    			<div class="post-featured-image">
				    			<div class="featured-image" style="background-image: url('<?php the_post_thumbnail_url( 'full' ); ?>');">
			                        <a href="<?php the_permalink(); ?>" class="post-thumbnail-link"></a>
			                    </div><!-- .featured-image -->
