...
function classic_blogbell_popular_news() {
	register_widget( 'Classic_BlogBell_Latest_News' );
}
add_action( 'widgets_init', 'classic_blogbell_popular_news' );

class Classic_BlogBell_Latest_News extends WP_Widget{ 

	function __construct() {
		global $control_ops;
		$widget_popular = array(
		  'classname'   => 'popular-news',
		  'description' => esc_html__( 'Add Widget to Display Popular Posts.', 'classic-blogbell' )
		);
		parent::__construct( 'Classic_BlogBell_Latest_News',esc_html__( 'St: Popular Posts', 'classic-blogbell' ), $widget_popular, $control_ops );
	}

	function form( $instance ) {
		$instance = wp_parse_args( (array) $instance, 
			array( 
			  'title'			=> esc_html__( 'Popular Posts', 'classic-blogbell' ),		
			  'category'       	=> '', 
			  'number'          => 5, 
			  'show_category'	=> true,	
			) 
		);
		$title     			= isset( $instance['title'] ) ? esc_html( $instance['title'] ) : esc_html__( 'Popular Posts', 'classic-blogbell' );
		...
		<p>
			...
			<?php
				wp_dropdown_categories(array(
					'show_option_none' => '',
					'class' 		  => 'widefat',
					'show_option_all'  => esc_html__('Popular Posts','classic-blogbell'),
	                                        ...
	                                        <div class="entry-container">
	                                            ...
	                                            <?php if ( 1 == $i ) : ?>
	                                                <div class="entry-content">
	                                                    <?php 
	                                                    	$excerpt = classic_blogbell_the_excerpt( 15 );
